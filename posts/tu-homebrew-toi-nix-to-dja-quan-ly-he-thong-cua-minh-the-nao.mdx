...
tags: 
  ...
  - linux
date: 2024-03-16
excerpt: Tớ sẽ chia sẻ về cách mình quản lý hệ thống lập trình của mình, từ một hệ thống “bừa bãi” chỉ có homebrew, tới một hệ thống tớ nắm hoàn toàn quyền bằng Nix nhé 😽
